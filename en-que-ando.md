...
<div class="section">
    ...
    <div style="margin-top: 20px;">
        ...
        <div class="card" style="margin-bottom: 15px;">
            <p><strong>2023</strong> - "Phase transitions in a model of collective behavior with memory". <em>Physical Review E</em>, 107, 054123</p>
        </div>
        <div class="card" style="margin-bottom: 15px;">
            <p><strong>2022</strong> - "Accelerometer data reveals leadership patterns in bird flocks". <em>Journal of Animal Ecology</em>, 91, 2345-2358</p>
        </div>
    </div>
</div>
...
<div class="section">
    ...
    <div style="margin-top: 20px;">
        <div class="card" style="margin-bottom: 15px;">
            <p><strong>Nov 2023</strong> - "Modelado de tumoresferas con células madre cancerosas". <em>XXVI Congreso de Física Estadística, La Plata</em></p>
        </div>
        <div class="card" style="margin-bottom: 15px;">
            <p><strong>Jul 2023</strong> - "Collective behavior in birds: from data to models". <em>International Conference on Biological Physics, Río de Janeiro</em></p>
        </div>
        <div class="card" style="margin-bottom: 15px;">
            <p><strong>Oct 2022</strong> - "Nuevas formas de interacción en sistemas de agentes". <em>Reunión Anual de la Asociación Física Argentina, Tucumán</em></p>
        </div>
    </div>
</div>